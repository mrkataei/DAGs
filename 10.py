...
__dag_properties = {'dag_id': 10, 'description': None}
__tasks = [{'task_id': 40, 'task_name': 'sam_40_40', 'pipeline_options': {'config': '{"ports": {"inputs": [], "outputs": [{"id": 2, "name": "string", "type": "string", "config": {"file_path": "opt/airflow/data/test_output"}, "priority": 0, "required": true, "port_status": "Port Status 1"}]}, "configuration": {"file_path": "/opt/airflow/data/test_input.csv"}}'}, 'py_file': 'lagrange_workflow.module.io.read_file'}, {'task_id': 42, 'task_name': 'search_42_42', 'pipeline_options': {'config': '{"ports": {"inputs": [], "outputs": [{"id": 2, "name": "string", "type": "string", "config": {"file_path": "opt/airflow/data/test_output"}, "priority": 0, "required": true, "port_status": "Port Status 1"}]}, "configuration": {"file_path": "/opt/airflow/data/test_input.csv"}}'}, 'py_file': 'lagrange_workflow.module.io.read_file'}, {'task_id': 41, 'task_name': 'reader_41_41', 'pipeline_options': {'config': '{"ports": {"inputs": [], "outputs": [{"id": 2, "name": "string", "type": "string", "config": {"file_path": "opt/airflow/data/test_output"}, "priority": 0, "required": true, "port_status": "Port Status 1"}]}, "configuration": {"file_path": "/opt/airflow/data/test_input.csv"}}'}, 'py_file': 'lagrange_workflow.module.io.read_file'}]
__dependencies = {41: [42], 42: [40], 40: []}
