...
__dag_properties = {'dag_id': 9, 'description': None}
__tasks = [{'task_id': 37, 'task_name': 'reader_37_37', 'pipeline_options': {'config': '{"ports": {"inputs": [], "outputs": [{"id": 2, "name": "string", "type": "string", "config": {"file_path": "opt/airflow/data/test_output"}, "priority": 0, "required": true, "port_status": "Port Status 1"}]}, "configuration": {"file_path": "/opt/airflow/data/test_input.csv"}}'}, 'py_file': 'lagrange_workflow.module.io.read_file'}, {'task_id': 38, 'task_name': 'searcher_38_38', 'pipeline_options': {'config': '{"ports": {"inputs": [], "outputs": [{"id": 2, "name": "string", "type": "string", "config": {"file_path": "opt/airflow/data/test_output"}, "priority": 0, "required": true, "port_status": "Port Status 1"}]}, "configuration": {"file_path": "/opt/airflow/data/test_input.csv"}}'}, 'py_file': 'lagrange_workflow.module.io.read_file'}, {'task_id': 36, 'task_name': 'remap_36_36', 'pipeline_options': {'config': '{"ports": {"inputs": [], "outputs": [{"id": 2, "name": "string", "type": "string", "config": {"file_path": "opt/airflow/data/test_output"}, "priority": 0, "required": true, "port_status": "Port Status 1"}]}, "configuration": {"file_path": "/opt/airflow/data/test_input.csv"}}'}, 'py_file': 'lagrange_workflow.module.io.read_file'}, {'task_id': 39, 'task_name': 'sam_39_39', 'pipeline_options': {'config': '{"ports": {"inputs": [], "outputs": [{"id": 2, "name": "string", "type": "string", "config": {"file_path": "opt/airflow/data/test_output"}, "priority": 0, "required": true, "port_status": "Port Status 1"}]}, "configuration": {"file_path": "/opt/airflow/data/test_input.csv"}}'}, 'py_file': 'lagrange_workflow.module.io.read_file'}]
__dependencies = {37: [39], 39: [], 38: [37], 36: [38]}
