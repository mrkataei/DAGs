...
__dag_properties = {'dag_id': 3, 'description': None}
__tasks = [{'task_id': 24, 'task_name': 'string_24_24', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 25, 'task_name': 'string_25_25', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 26, 'task_name': 'string_26_26', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 27, 'task_name': 'string_27_27', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 28, 'task_name': 'string_28_28', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}]
__dependencies = {25: [28, 24, 27], 28: [26], 24: [], 26: [], 27: []}
