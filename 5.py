...
__dag_properties = {'dag_id': 5, 'description': None}
__tasks = [{'task_id': 12, 'task_name': 'string_12_12', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 13, 'task_name': 'string_13_13', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 15, 'task_name': 'string_15_15', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 16, 'task_name': 'string_16_16', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 17, 'task_name': 'string_17_17', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 18, 'task_name': 'string_18_18', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}]
__dependencies = {17: [16], 16: []}
