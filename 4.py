...
__tasks = [{'task_id': 19, 'task_name': 'string_19_19', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 20, 'task_name': 'string_20_20', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 21, 'task_name': 'string_21_21', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 22, 'task_name': 'string_22_22', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 23, 'task_name': 'string_23_23', 'pipeline_options': {'config': '{"ports": null, "configuration": {}}'}, 'py_file': None}, {'task_id': 14, 'task_name': 'read_file_14_14', 'pipeline_options': {'config': '{"ports": {"inputs": [], "outputs": [{"id": 2, "name": "string", "type": "string", "config": {"file_path": "opt/airflow/data/test_output"}, "priority": 0, "required": true, "port_status": "Port Status 1"}]}, "configuration": {"file_path": "/opt/airflow/data/test_input.csv"}}'}, 'py_file': None}]
